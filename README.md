...
A high concurrency e-commerce backend designed for strict data integrity and secure financial transactions. Built to push past standard CRUD tutorials by implementing real world architectural patterns, atomic database transactions, and secure session management.
